...
if __name__ == '__main__':
    ...
    if len(sys.argv) < 2:
        print("Usage: python test-ocr-direct.py <content-id>")
        sys.exit(1)
    ...
    print(f"Triggering OCR for content: {content_id}")

    # Invoke workflow directly with DBOS
    handle = DBOS.start_workflow(ocr_workflow, content_id)

    print(f"✓ OCR workflow started")
